      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
         <li><a href="login.jsp">Home</a></li>
           <li><a href="Flogin.jsp">Hospital</a></li>
           <li><a href="Alogin.jsp">Admin</a>
  ...
  <main id="main">
    ...
    <h1>Admin Login</h1>
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-6"  class="info-wrap">
              ...
              <div class="col-md-10 form-group mt-3 mt-md-0">
               ...
               <div class="row">
                <div class="col-md-6 form-group">
                 ...
                 <div class="col-md-6 form-group">
                   <div class="text-center"><a href="register.jsp"></a></div>
                </div><br/>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">shyam</a>
        </div>
      </div>
